...
| Script | Target | Host |
|---|---|---|
| `leolist-listings-only.user.js` — **LeoList — listings only: no sponsored, no chrome, photo filmstrip** | leolist.cc — every classified category: the listing column only, sponsored rows dropped, detail-page photos as a filmstrip, dark by default | [![Sleazy Fork](https://img.shields.io/greasyfork/v/595756?label=Sleazy%20Fork)](https://sleazyfork.org/en/scripts/595756-leolist-listings-only-no-sponsored-no-chrome-photo-filmstrip) [![installs](https://img.shields.io/greasyfork/dt/595756)](https://sleazyfork.org/en/scripts/595756-leolist-listings-only-no-sponsored-no-chrome-photo-filmstrip) |
| `thumbwall.user.js` — **Pornhub, XVideos, XNXX, xHamster & Eporner – Clean Widescreen Gallery** | pornhub.com · xnxx.com · xvideos.com · eporner.com · xhamster.com — full-bleed thumbnail wall, autohiding header, video page reduced to player + info strip + related | [![Sleazy Fork](https://img.shields.io/greasyfork/v/595735?label=Sleazy%20Fork)](https://sleazyfork.org/en/scripts/595735-xvideos-xnxx-xhamster-eporner-clean-widescreen-gallery) [![installs](https://img.shields.io/greasyfork/dt/595735)](https://sleazyfork.org/en/scripts/595735-xvideos-xnxx-xhamster-eporner-clean-widescreen-gallery) |
